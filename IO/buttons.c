...
#include "buttons.h" // The header file
#include <stdint.h> 
#include <stdbool.h>
...
static uint8_t but_count[NUM_BUTS]; // The count of the amount of buttons
...
@param butName the name to be used to check for a specific button
@return the state of the button either  RELEASED, PUSHED or NO_CHANGE */
uint8_t
